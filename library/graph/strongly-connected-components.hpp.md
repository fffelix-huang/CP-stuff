...
data:
  ...
  attributes:
    links: []
  bundledCode: "#line 2 \"library/graph/strongly-connected-components.hpp\"\n#include\
    \ <vector>\n#include <cassert>\n#include <algorithm>\n#include <functional>\n\n\
    namespace felix {\n\nstruct SCC {\npublic:\n\tSCC() : n(0) {}\n\texplicit SCC(int\
...
layout: document
redirect_from:
- /library/library/graph/strongly-connected-components.hpp
- /library/library/graph/strongly-connected-components.hpp.html
