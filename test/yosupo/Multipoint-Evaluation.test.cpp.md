...
data:
  ...
  bundledCode: "#line 1 \"test/yosupo/Multipoint-Evaluation.test.cpp\"\n#define PROBLEM\
    \ \"https://judge.yosupo.jp/problem/multipoint_evaluation\"\r\n\r\n#include <iostream>\r\
    ...
    \ int)(m);\r\n\tunsigned long long r = 1;\r\n\tunsigned long long y = internal::safe_mod<long\
    \ long>(x, m);\r\n\twhile(n) {\r\n\t\tif(n & 1) {\r\n\t\t\tr = (r * y) % _m;\r\
    \n\t\t}\r\n\t\ty = (y * y) % _m;\r\n\t\tn >>= 1;\r\n\t}\r\n\treturn r;\r\n}\r\n\
    ...
    \n\r\npublic:\r\n\tstatic constexpr int primitive_root = ntt_internal::primitive_root_constexpr(mod);\r\
...
layout: document
redirect_from:
- /verify/test/yosupo/Multipoint-Evaluation.test.cpp
- /verify/test/yosupo/Multipoint-Evaluation.test.cpp.html
