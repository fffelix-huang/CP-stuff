...
data:
  ...
  bundledCode: "#line 1 \"test/yosupo/Sqrt-of-Formal-Power-Series.test.cpp\"\n#define\
    ...
    \ y = internal::safe_mod<long long>(x, m);\r\n\twhile(n) {\r\n\t\tif(n & 1) {\r\
    \n\t\t\tr = (r * y) % _m;\r\n\t\t}\r\n\t\ty = (y * y) % _m;\r\n\t\tn >>= 1;\r\n\
    \t}\r\n\treturn r;\r\n}\r\n\r\nconstexpr int primitive_root_constexpr(int m) {\r\
    ...
    \ = ntt_internal::primitive_root_constexpr(mod);\r\n\r\n\tstatic void prepare(int\
    ...
    return ans;\r\n\t}\r\n\r\nprivate:\r\n\tstd::vector<mint> a;\r\n};\r\n\r\n} //\
    \ namespace felix\r\n#line 5 \"test/yosupo/Sqrt-of-Formal-Power-Series.test.cpp\"\
