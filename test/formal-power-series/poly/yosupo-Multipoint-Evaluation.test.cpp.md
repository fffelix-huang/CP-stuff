...
data:
  ...
  bundledCode: "#line 1 \"test/formal-power-series/poly/yosupo-Multipoint-Evaluation.test.cpp\"\
    ...
    \ 0, n, mulT(q[1].inv(n)));\r\n\t\treturn ans;\r\n\t}\r\n\r\nprivate:\r\n\tstd::vector<mint>\
    \ a;\r\n};\r\n\r\n} // namespace felix\r\n#line 7 \"test/formal-power-series/poly/yosupo-Multipoint-Evaluation.test.cpp\"\
  ...
  verifiedWith: []
documentation_of: test/formal-power-series/poly/yosupo-Multipoint-Evaluation.test.cpp
layout: document
redirect_from:
- /verify/test/formal-power-series/poly/yosupo-Multipoint-Evaluation.test.cpp
- /verify/test/formal-power-series/poly/yosupo-Multipoint-Evaluation.test.cpp.html
