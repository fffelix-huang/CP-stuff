...
data:
  ...
  bundledCode: "#line 1 \"test/tree/heavy-light-decomposition/yosupo-Jump-on-Tree.test.cpp\"\
    ...
    \ u);\r\n\t\ttour.push_back(u);\r\n\t\tfor(auto v : g[u]) {\r\n\t\t\ttop[v] =\
    \ (v == g[u][0] ? top[u] : v);\r\n\t\t\tdfs_link(v);\r\n\t\t\teuler_tour.emplace_back(depth[u],\
    \ u);\r\n\t\t}\r\n\t}\r\n};\r\n\r\n} // namespace felix\r\n#line 5 \"test/tree/heavy-light-decomposition/yosupo-Jump-on-Tree.test.cpp\"\
